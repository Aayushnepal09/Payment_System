...
class project extends JFrame implements ActionListener {
    ...
    project(){
        ...
        t1.setIcon(new ImageIcon(ClassLoader.getSystemResource("PS/icons/New.png")));
        ...
        t3.setMnemonic('S');
        t3.setIcon(new ImageIcon(ClassLoader.getSystemResource("PS/icons/schedreport.PNG")));
        ...
        t4.setMnemonic('L');
        t4.setIcon(new ImageIcon(ClassLoader.getSystemResource("PS/icons/newinvoice.png")));
        ...
        s1.setMnemonic('U');
        s1.setIcon(new ImageIcon(ClassLoader.getSystemResource("PS/icons/EditOpen.png")));
        ...
        s2.setMnemonic('p');
        s2.setIcon(new ImageIcon(ClassLoader.getSystemResource("PS/icons/empreport.png")));
        ...
        s3.setMnemonic('T');
        s3.setIcon(new ImageIcon(ClassLoader.getSystemResource("PS/icons/EXPENSE.PNG")));
        ...
        p1.setMnemonic('P');
        p1.setIcon(new ImageIcon(ClassLoader.getSystemResource("PS/icons/payments.png")));
        ...
        p2.setMnemonic('L');
        p2.setIcon(new ImageIcon(ClassLoader.getSystemResource("PS/icons/empreport.png")));
        ...
        u1.setIcon(new ImageIcon(ClassLoader.getSystemResource("PS/icons/New.png")));
        ...
        u2.setIcon(new ImageIcon(ClassLoader.getSystemResource("PS/icons/calc.png")));
        ...
        m8i1.setMnemonic('X');
        m8i1.setIcon(new ImageIcon(ClassLoader.getSystemResource("PS/icons/exit.png")));
